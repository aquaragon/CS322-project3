...
def check():
    ...
    matches = flask.request.args.getlist("matches[]", type=str)  # Default to empty list
    ...
    result = {"in_jumble": in_jumble, "inputtext": text, "jumble": jumble,
              "matches": matches, "matched": matched, "target_count": target_count}
